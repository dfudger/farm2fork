...
<div class="row-fluid">
    ...
    <div class="span6">
        <h3>The Creation</h3>
        <p>
            The idea of Farm2Fork originated from the <a href="http://www.spiritwind-christian-centre.ca/guelphfoodbank.html">Guelph Food Bank</a>, in consultation with <a href="http://www.thelettermmarketing.com">The Letter M Marketing</a>.  As the project began to take shape, a list of requirements was developed and a web based solution was proposed.  Danny Williamson of The Letter M Marketing collaborated with Dr. Daniel Gillis of the <a href="http://www.uoguelph.ca">University of Guelph</a> and it was decided to enlist a group of students in their third year software development course to be the development team for the project.   
        </p>
    </div>
</div> <!-- End Row -->
